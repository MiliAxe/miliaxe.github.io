...
tags:
  - AI
  - productivity
description: How should we learn in these times of AI abundance?
---
...
This has led to me thinking that we should have some sort of rulebook for using AIs, or maybe some sort of optimized AI for learning that refuses to answer questions when your learning might be bypassed. [This article](https://scale.stanford.edu/ai/repository/ai-meets-classroom-when-do-large-language-models-harm-learning) from Stanford has done some research on how using LLMs can harm learning and, they clearly show that using LLMs for substituting tasks that require mental effort result in less understanding.

[Some](https://www.seangoedecke.com/learning-from-llms/) also claim that the studies don't really apply to their case as an adult who is trying to learn new topics. The context matters a lot here, whether you are trying to use LLMs for academia or your own knowledge.
...
- An alternative to having a rulebook would be to have a routine while learning or addressing problems:
  - Before getting answers from a model, attempt to think about it beforehand and write your own thoughts on the problem. It doesn't matter how bad it is.
  - After getting the response from the model, try to explain it to yourself afterwards or attempt to reproduce the result on your own without any help from the model.
